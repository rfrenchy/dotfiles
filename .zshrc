...
# DON'T COMMA-SEPERATE VALUES OR IT WON'T WORK
plugins=(git web-search copyfile copybuffer dirhistory zsh-autosuggestions)
...
docker-exist() {
  docker manifest inspect $1 > /dev/null ; echo $?
}
